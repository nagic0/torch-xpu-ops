...
if(USE_ZE_XPU)
  target_compile_options(torch_xpu_ops PRIVATE "-DUSE_ZE_XPU")
  target_include_directories(torch_xpu_ops PUBLIC ${TORCH_XPU_OPS_LEVEL_ZERO_INCLUDE_DIR})
  target_link_libraries(torch_xpu_ops PUBLIC ${TORCH_XPU_OPS_LEVEL_ZERO_LIBRARIES})
endif()